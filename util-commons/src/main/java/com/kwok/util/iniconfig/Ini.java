 ...
 *
 * @From Apache-Shiro : shiro-config-core-1.7.1.jar : org.apache.shiro.config.Ini.class
 */
public class Ini implements Map<String, Ini.Section> {
    ...
    public static Ini fromResourcePath(String resourcePath) throws Exception {
    ...
    public void loadFromPath(String resourcePath) throws Exception {
        InputStream is;
        try {
    ...
    public void load(String iniConfig) throws Exception {
